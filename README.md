...
当前版本 **0.9.2** · 已验证宿主 **DSH 0.1.1-rc.2** · **CC-BY-NC-4.0（非商业）**

0.9.2 修复稿件身份检查、任务完成后卡住、扫描失败清空清单及大目录范围失效。修改与复核前后会核对工作区内真实文件；3 个缺少上游执行程序的命令暂不启用。升级后需重启 DSH 并刷新浏览器，详见 [更新说明](docs/CHANGELOG.zh-CN.md)。
